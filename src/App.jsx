    ...
    <div style={{fontFamily:"Segoe UI,Arial,sans-serif",minHeight:"100vh",background:"#faf8f8",display:"flex",flexDirection:"column"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        .site-header{background:linear-gradient(135deg,#6b2018 0%,#823122 100%);color:white;box-shadow:0 2px 12px rgba(0,0,0,.2)}
        ...
        .hero-banner{background:linear-gradient(to right,#6b2018,#823122);color:white;text-align:center;padding:2rem 1.5rem}
          ...
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>contato@chacara.com.br</li>
